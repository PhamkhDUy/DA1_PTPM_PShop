...
-- distributed transaction and XA support for the Microsoft JDBC Driver 8.4 for SQL Server.
...
if
exists (select * from sys.database_principals where name = 'SqlJDBCXAUser' and type='R')
